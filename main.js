...
me.family = ["Dan ", "Colleen ", "Andrew ", "Madison "];
...
document.getElementById("q3a").innerHTML = "Dot Notation: " + me.city;
document.getElementById("q3b").innerHTML = "Bracket Notation: " + me["city"];
...
document.getElementById("q9b").innerHTML = "She will be eating " + invitees.adults[2].dinnerChoice[1] + " for dinner, and has selected " + invitees.adults[2].dinnerChoice[2] + " for dessert.";
...
document.getElementById("q10").innerHTML = "This JS class has the following students: " + JSON.stringify(jsWorkshop) ;

console.log(jsWorkshop);

// 11. To your "jsWorkshop" object, assign a key of "classmates" with the value being an array of five your classmates.
var jsWorkshop = new Object();
jsWorkshop.classmates = ["Erica ", "Grace ", "Kevin ", "Trevor ", "Tom ", "Sam",];
document.getElementById("q11").innerHTML = "This JS class has the following students: " + JSON.stringify(jsWorkshop) ;
...
var jsWorkshop = new Object();
jsWorkshop.classmates = ["Erica ", "Grace ", "Kevin ", "Trevor ", "Tom ", "Sam",];
document.getElementById("q12").innerHTML = "The fourth classmate is " + jsWorkshop.classmates[3] + " and his name has " + jsWorkshop.classmates[3].length + " letters.";
...
document.getElementById("q13").innerHTML = JSON.stringify(jsWorkshop);
